...
export const siteRouteSections: SiteRouteSection[] = [
  {
    ...
    routes: [
      ...
      },
      {
        href: "/features",
        label: "Features",
        description: "Dedicated product overview page for the platform's major capabilities.",
      },
      {
        href: "/exports",
        label: "Export Tools",
        description: "Download notes, prayer journal entries, and collections as text or PDF-friendly files.",
      },
      {
        href: "/search",
        label: "Search",
      ...
      },
      {
        ...
        description: "Review saved study activity and recent reading history.",
      },
      {
        href: "/new-believers",
        label: "New Believers Program",
        description: "A structured 6-week discipleship path for new Christians.",
      },
      {
        href: "/churches",
        label: "Church Profiles",
        description: "Custom spaces for churches and ministries using the platform.",
      },
      {
        href: "/family",
        label: "Family Mode",
        description: "Shared household reading plans and parent-child memory rhythms.",
      },
    ],
  },
  {
    ...
    routes: [
      ...
      },
      {
        href: "/sermon-notes",
        label: "Sermon Notes",
        description: "Capture church teaching, passage notes, and follow-up prayers.",
      },
      {
        href: "/topics",
        label: "Topic Studies",
        description: "Guided pathways for themes like anxiety, prayer, forgiveness, holiness, and identity in Christ.",
      },
      {
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        href: "/church-events",
        label: "Church Events",
        description: "Browse events, sermons, and church gathering follow-up.",
      },
      {
        href: "/testimonies",
        label: "Testimony Wall",
        description: "Read answered prayers and stories of spiritual growth.",
      },
      {
        href: "/audio",
        label: "Audio",
  ...
  },
  {
    ...
    routes: [
      ...
      {
        href: "/journeys",
        label: "Atlas Journeys",
        description: "Follow guided biblical movements through locations and passages.",
      },
      {
        href: "/maps/jerusalem",
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        description: "Push and restore local study data across devices for signed-in users.",
      },
    ],
  },
  {
